...
//    }
	...
	public static function links( $obj ) {
		...
		$obj->elControls[] = [
			...
			'options'     => [
				'link'   => esc_html__( 'Same Tab', 'tlp-food-menu' ),
				'target' => esc_html__( 'New Tab', 'tlp-food-menu' ),
			],
			'default'     => 'link',
			'label_block' => true,
			'condition'   => [
				'fmp_detail_page_link' => [ 'yes' ],
				'fmp_detail_page_popup!' => [ 'yes' ],
			],
			'separator'   => 'after',
		];
